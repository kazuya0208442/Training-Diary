...
## ・どこから始める？
まずは、オリンピックの強化選手として活動していた「スポーツ科学情報センター」に対して、アスリート育成事業のIT化を提案します。現在も1年に１回、競技成績の報告や OB としての活動を行っていますので、話し合いの場はたくさんあります。今年も３月までに報告書を提出しなければいけませんので、その時に今回のサービスについて提案してみます。
