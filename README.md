...
# 📖 どうやって勉強したのですか？
プログラミングは授業や研究で少し触ったことがある程度で、ほとんど知識はありませんでした。ですので、私と同じように異業種からエンジニアになった方の note の記事[「【転職エントリ】Googleに入社します」](https://note.com/neko_chan0214/n/n3a64bc1e1412)を参考にしました。基本的に英語で学習を進めようと思い、この記事に書いてある「DataCamp」と呼ばれる海外のオンライン学習プラットフォームで Python の基礎を学びました。また、AtCoder でアルゴリズムとデータ構造について勉強し、今は茶色コーダーになりました。その後、Google の検索地域をアメリカ合衆国にして、アプリの作り方を検索しました。検索結果の5ページ分を全てタブで開いて、１番分かりやすく解説をしている記事を30個ほど選びまして、その中からさらに厳選して、下記の９人の方の記事を主に参考にしました。それと同時に、AWS や Docker、Django の公式サイトのチュートリアルやドキュメントを読むようにしていました。
