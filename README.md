...
毎年１回、国に競技成績や活動報告をする「報告会」があります。選手の現状を聞いて、どんな支援をするのかを検討することが目的です。実はスポーツを引退している選手でも、OB として活動に関わることができまして、現役の選手への指導や講演会など、いろいろな形で未来のアスリートになる子供たちのために活動をすることができます。
